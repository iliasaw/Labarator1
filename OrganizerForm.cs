...
namespace OrganizerApp
{
    public partial class OrganizerForm : Form
    {
        ...
        private void AddEventItem(DateTime datetime, string description, string category)
        {
            ...
            item.Tag = new { Date = datetime, Description = description, Category = category };
        ...
        {
            MessageBox.Show("Сохранение данных в файл", "Save", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }

        private void OpenFromFile()
        {
            MessageBox.Show("Открытие данных из файла", "Open", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
